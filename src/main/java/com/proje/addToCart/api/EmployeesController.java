...
public class EmployeesController {
	...
	@PostMapping("/login")
	public List<Employee> login(@RequestBody LoginRequest loginRequest) {
		List<Employee> list =this.employeeService.login(loginRequest.getName(), loginRequest.getPassword());
